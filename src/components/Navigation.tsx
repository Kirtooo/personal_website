...
const socialLinks = [
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/tingchen-leo-yuan-3416aa250/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export default function Navigation() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-white/70 dark:bg-black/70 border-b border-gray-200 dark:border-gray-800"
    >
